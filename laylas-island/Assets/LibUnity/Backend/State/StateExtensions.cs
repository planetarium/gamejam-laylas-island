...
namespace LibUnity.Backend.State
{
    public static class StateExtensions
    {
        ...
        public static int ToInteger(this IValue serialized) =>
            int.Parse(((Integer) serialized).Value.ToString(CultureInfo.InvariantCulture));
        ...
        public static T GetValue<T>(this Dictionary serialized, string key, T defaultValue,
            IValueTryParseDelegate<T> tryParser)
        {
        ...
        public static DateTimeOffset GetDateTimeOffset(this Dictionary serialized, string key,
        ...
        public static FungibleAssetValue ToFungibleAssetValue(this IValue serialized) =>
            serialized is List serializedList
                ? FungibleAssetValue.FromRawValue(
                    new Currency(serializedList.ElementAt(0)),
